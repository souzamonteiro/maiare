...
// REx command line: EcmaScript.ebnf -tree -main -ll 1 -backtrack -asi -java
...
public class EcmaScript
{
  public static void main(String args[]) throws Exception
  {
    if (args.length == 0)
    {
      System.out.println("Usage: java EcmaScript [-i] INPUT...");
      System.out.println();
    ...
    else
    {
      ...
      for (String arg : args)
      {
        ...
        EcmaScript parser = new EcmaScript(input, s);
        try
        {
